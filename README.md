...
I added the elements on the page with React, just one line in the body of the HTML, and implemented a mobile-first, responsive layout (optimized for the three required screen sizes). This app is responsive for mobiles, tablets and desktops.
